...
import { JobRequest, ModifyJobRequestDto } from 'services/api';

export type RequestFields = ModifyJobRequestDto;
interface Props {
  title: string;
  ...
  return (
    <form onSubmit={methods.handleSubmit(onSubmit)} title={title}>
      <Stack spacing={2} width={'100%'}>
        ...
        <TextField {...methods.register('salary')} label="Ожидаемая зарплата" type={'number'} />
